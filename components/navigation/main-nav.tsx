...
export function MainNav() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-sm border-b border-white/10 transition-transform duration-300">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-white font-bold text-lg hidden sm:block">NASA Defense</span>
          </Link>
              ...
              return (
                <Link key={item.name} href={item.href}>
                  <Button
                    ...
                    size="sm"
                    className={`text-white hover:text-white hover:bg-white/10 ${isActive ? "bg-white/20" : ""}`}
                  >
