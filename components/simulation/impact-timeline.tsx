...
export function ImpactTimeline({
  ...
  const timelineEvents: TimelineEvent[] = [
    {
      time: 0,
      title: "Impact",
      description: "Asteroid strikes Earth surface",
      severity: "critical",
    },
    {
      time: 0.1,
      title: "Fireball Formation",
      description: "Superheated plasma expands rapidly",
      severity: "critical",
    },
    {
      time: 1,
      title: "Shockwave",
      description: "Pressure wave propagates outward",
      severity: "high",
    },
    {
      time: 5,
      title: "Crater Formation",
      description: "Impact crater begins to form",
      severity: "high",
    },
    {
      time: 30,
      title: "Ejecta Blanket",
      description: "Debris rains down in surrounding area",
      severity: "high",
    },
    {
      time: 60,
      title: "Seismic Waves",
      description: "Earthquake waves travel through Earth",
      severity: "medium",
    },
    {
      time: 300,
      title: "Atmospheric Effects",
      description: "Dust and debris enter atmosphere",
      severity: "medium",
    },
    {
      time: 3600,
      title: "Regional Impact",
      description: "Effects spread to wider region",
      severity: "medium",
    },
    {
      time: 86400,
      title: "Global Effects",
      description: "Worldwide climate impact begins",
      severity: "low",
    },
  ];
  ...
  useEffect(() => {
    const active = timelineEvents.filter(
      (event) => event.time <= currentTime && currentTime < event.time + 60
    );
      ...
      <Card className="h-full">
        ...
        <CardContent>
          <div className="text-center text-muted-foreground py-8">
            Run an impact simulation to see timeline
          </div>
        </CardContent>
      </Card>
    );
